...
namespace nilnul.blob_.excel.book.mesh._cel
{
	...
	{
		OrdI2 obj.mesh._cel._coord_.ColI<OrdI2>.col => col;

		OrdI2 obj.mesh._cel._coord_.RowI<OrdI2>.row => row;
		...
		static public Coord OvColRowNilBased(nilnul.num.OrdI2 col, BigInteger row)
		{
			return new Coord(
				 new obj.mesh._cel.Coord(col,row)
			);
		...
		public Coord(obj.mesh._cel.CoordI x)
			:this(
				 new UpperLetter(x.col)
				 ,
				 new OneBased(x.row)
		...
		public Coord(num.OrdI2 col, num.OrdI2 row)
			:this(
				 new UpperLetter(col)
				 ,
				 new OneBased(row)
		...
		//public Coord(num.OrdI2 col, BigInteger row)
		//	:this(
		//		 new UpperLetter(col)
		//		 ,
		//		 new nilnul.num.Ord2(row)
		//	 )
		//{
