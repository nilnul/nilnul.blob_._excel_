...
namespace nilnul.fs.excel.doc.sheet.dwelt.asTbl_
{
	static public class _AsTableX
	{
		...
		static public DataTable GetTable(
			nilnul.blob_.excel.doc.sheet.Dwelt doc
		)
		{

			var r = new System.Data.DataTable();

			if (doc.rowRange.None())
			{
				return r;
			...
			var head = doc.rowRange.First();


			var dweltRow= nilnul.blob_.excel.doc.sheet.dwelt.row.
